...
export const login = async (req, res) => {
  try {
    ...
    const access_token = generateAccessToken({ userId: existUser.id, roles: existUser.roles });
    const refresh_token = generateRefreshToken({ userId: existUser.id, roles: existUser.roles });
